...
funannotate predict -i new_file.fa -o fun --species "pichia stipitis" --organism other --force
# force only when contigs are of questionable quality and have repeated bases maybe only 2 alphabets. Not recommended.
